        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => CreatePetProfileWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              path: 'editPetProfile',
              asyncParams: {
                'petProfile': getDoc(['pets'], PetsRecord.serializer),
              },
              builder: (context, params) => EditPetProfileWidget(
                petProfile: params.getParam('petProfile', ParamType.Document),
              ),
            ),
            FFRoute(
              name: 'changePassword',
            ...
            FFRoute(
              ...
              builder: (context, params) => ViewProfilePageOtherWidget(
                ...
                petDetails: params.getParam('petDetails', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'createPetProfile_New',
              path: 'createPetProfileNew',
              builder: (context, params) => CreatePetProfileNewWidget(),
            ),
            FFRoute(
              name: 'chatPage',
              path: 'chatPage',
