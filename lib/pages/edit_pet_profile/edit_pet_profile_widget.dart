...
import 'edit_pet_profile_model.dart';
export 'edit_pet_profile_model.dart';
...
class _EditPetProfileWidgetState extends State<EditPetProfileWidget> {
  late EditPetProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPetProfileModel());

    _model.petNameController ??=
        TextEditingController(text: widget.petProfile!.petName);
    _model.petAgeController ??=
        TextEditingController(text: widget.petProfile!.petAge);
    _model.petBioController ??=
        TextEditingController(text: widget.petProfile!.petBio);
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                'Preencha os perfis do seu animal de estimação abaixo! E então comece a compartilhar seus filhotes!',
                          ...
                          onPressed: () async {
                            var confirmDialogResponse = await showDialog<bool>(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text(
                                          'Você está prestes a deletar o pet!'),
