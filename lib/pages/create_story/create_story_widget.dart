                            ...
                            child: Container(
                              ...
                              child: Stack(
                                children: [
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.03, -0.12),
                                    child: Lottie.network(
                                      'https://assets6.lottiefiles.com/packages/lf20_KLp8DRb753.json',
                                      width: 150.0,
                                      height: 130.0,
                                      fit: BoxFit.cover,
                                      animate: true,
                                  ...
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.04, 0.29),
                                    child: AutoSizeText(
                                      'Selecione uma foto da sua galeria ou tire uma nova',
