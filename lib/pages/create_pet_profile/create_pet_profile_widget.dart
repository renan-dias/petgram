...
import 'create_pet_profile_model.dart';
export 'create_pet_profile_model.dart';
...
class _CreatePetProfileWidgetState extends State<CreatePetProfileWidget> {
  late CreatePetProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatePetProfileModel());
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            'Você poderá adicionar outros pets a seu perfil depois',
                            style: FlutterFlowTheme.of(context).bodySmall,
                          ),
                        ],
                      ),
