...
final parametersBuilderMap =
  ...
  'createPetProfile': ParameterData.none(),
  ...
  'editPetProfile': (data) async => ParameterData(
        allParams: {
          'petProfile': await getDocumentParameter<PetsRecord>(
              data, 'petProfile', PetsRecord.serializer),
        },
      ),
  ...
  'viewProfilePageOther': (data) async => ParameterData(
        allParams: {
          ...
          'petDetails': getParameter<String>(data, 'petDetails'),
        },
      ),
  'createPetProfile_New': ParameterData.none(),
