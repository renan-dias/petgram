    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'postOwner':
          ...
          break;
        case 'postLocale':
          result.postLocale = serializers.deserialize(value,
...
class _$UserPostsRecord extends UserPostsRecord {
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, postLocale.hashCode);
...
class UserPostsRecordBuilder
  ...
  LatLng? _postLocale;
  LatLng? get postLocale => _$this._postLocale;
  set postLocale(LatLng? postLocale) => _$this._postLocale = postLocale;
